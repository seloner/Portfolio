			...
			<div className={cx('px-4 mx-auto', { 'opacity-40': !isPlayed })}>
				<RoughNotationGroup show={isPlayed}>
					<h1 className='text-2xl font-bold text-gray-900 lg:text-4xl'>
						Hello! I'm Delba, a{' '}
						<RainbowHighlight color={colors[0]}>developer</RainbowHighlight> based in
						England.
					</h1>
					...
					<div className='mt-4 text-gray-700'>
						<p className='my-2'>
							...
							and <RainbowHighlight color={colors[2]}>delightful</RainbowHighlight>.
						</p>
						...
						<p className='my-2'>
							...
							. I also worked at Lambda where my role was split between helping scale
						...
						<p className='my-2'>
							...
							large, specialised and cross-functional teams across different time zones
							and developed a working style that leans towards{' '}
							<RainbowHighlight color={colors[1]}>flexibility,</RainbowHighlight>
							<RainbowHighlight color={colors[2]}>clarity,</RainbowHighlight> and{' '}
							<RainbowHighlight color={colors[3]}>collaboration</RainbowHighlight>.
						</p>
